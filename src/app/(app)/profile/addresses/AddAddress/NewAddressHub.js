...
export default function NewAddressHubPage() {
  ...
  return (
    <>
      <Row className="g-0">
        <h4 className="text-center mt-2">Nuevo domicilio</h4>
            <Form
            onSubmit={handleSubmit}
            className="d-flex flex-column align-items-center">
            <CardContainer className="bg-body mt-4 p-4 w-50">
                <FormGroup className="mb-4">
                <FormLabel className="text-muted">Dirección</FormLabel>
                <FormControl
                ...
                <Row className="mb-4">
                <FormGroup as={Col}>
                    <FormLabel className="text-muted">Código postal</FormLabel>
                    <FormControl
                    type="text"
                    name="last_name"
                ...
                <FormGroup as={Col} lg={6}>
                    <FormLabel className="text-muted">Estado</FormLabel>
                    <FormControl
                    type="text"
                    name="last_name"
                    value={formData.last_name}
